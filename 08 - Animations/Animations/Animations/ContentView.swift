...
//  Animations
//
//  Created by Fahad Mansuri on 18.01.24.
//
                    ...
                    ForEach(0..<3){number in
                        Button{
                            ...
                            FlagImage(countryName: countries[number])
                                //Project 6 - Challenge 1
                                .rotation3DEffect(Angle(degrees: number == correctAnswer ? animationAmount : 0), axis: (0,1,0))
                                //Project 6 - Challenge 2
                                .opacity(enabled ? (number == correctAnswer ? 1 : opacityAmount) : 1)
                                //Project 6 - Challenge 3
                                .scaleEffect(enabled ? (number == correctAnswer ? 1 : opacityAmount) : 1)
                        }
